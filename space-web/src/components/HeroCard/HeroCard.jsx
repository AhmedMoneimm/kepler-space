              ...
              {ServiceData.map((data, index) => {
                return (
                  <Link
                    ...
                    className="min-h-[180px] flex flex-col justify-center items-center rounded-xl gap-2 bg-sky-900/60 backdrop-blur-sm text-white text-center text-2xl py-8 px-3 w-full transition-transform duration-200 transform hover:scale-105 hover:-translate-y-2 hover:bg-sky-700 hover:shadow-lg hover:text-blue-200" // Updated translate
                  >
                    {data.icon}
